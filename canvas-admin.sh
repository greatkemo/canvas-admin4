...
input_user_search() {
  ...
  if [[ "$user_in_cache" == "true" ]]; then
    ...
    awk 'BEGIN { FS=","; OFS=": " } { gsub(/"/, "", $1); gsub(/"/, "", $2); gsub(/"/, "", $3); gsub(/"/, "", $4); gsub(/"/, "", $5); print "CANVAS_USER_ID", $1; print "USER_ID", $2; print "LOGIN_ID", $3; print "FULL_NAME", $4; print "EMAIL", $5; print "" }' <<< "$response"
  else
